...
import eu.europa.esig.dss.enumerations.VisualSignaturePlacement;
...
public class PdfBoxSignatureService extends AbstractPDFSignatureService {
     ...
     * @param signatureDrawerFactory drawer factory implementation to be used
     */
    ...
    private boolean placeSignatureOnPage(SignatureImageParameters signatureImageParameters) {
        if (signatureImageParameters.getPagePlacement() == VisualSignaturePlacement.SINGLE_PAGE) {
            return false;
        } else {
            return true;
        }
